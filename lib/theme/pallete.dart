...
ThemeData buildSimbaLightTheme(BuildContext context) {
  ...
  return base.copyWith(
    ...
    textTheme: _buildSimbaLightTextTheme(base.textTheme),
...
ThemeData buildSimbaDarkTheme(BuildContext context) {
  ...
  return base.copyWith(
    ...
    textTheme: _buildSimbaDarkTextTheme(base.textTheme),
...
TextTheme _buildSimbaLightTextTheme(TextTheme base) {
  return base.copyWith(
...
TextTheme _buildSimbaDarkTextTheme(TextTheme base) {
  return base.copyWith(
    headlineMedium: GoogleFonts.workSans(
      fontWeight: FontWeight.w600,
      fontSize: 34,
